...
public class downloadActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        downloadActivity.verifyStoragePermissions(this);
...
//                    DownTask task = new DownTask(downloadActivity.this, ItemChooseData.getFilePath().get(i));
...
//        ItemChooseData.getFilePath().clear();
    ...
    class DownTask extends AsyncTask<String, Long, Boolean> {
        ...
        protected Boolean doInBackground(String... Params) {
            ...
            downloadActivity.crSDFile(strdir);
            localPath = dirpath;
